      ...
      <div className="p-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            ...
            className="flex-1 py-2.5 bg-gradient-gold rounded-lg font-extrabold text-white text-sm hover:shadow-[0_0_30px_rgba(212,175,55,0.4)] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
          >
            {purchasing ? (
              ...
              <>
                ...
                <span className="font-extrabold">Purchase</span>
              </>
            )}
          </motion.button>
        </div>
